	...
	<style>
		...
		* {
		...
		.content {
			...
			background: var(--surface);
			display: block;
			/* Force block layout for children */
			position: relative;
		}
...
<body>
	<div class="layout">
		...
		<!-- MAIN -->
		<div class="main">
			<div class="topbar" style="justify-content: flex-start; gap: 12px;">
				...
				<div class="report-container">
					<div class="report-header">
						...
						<div class="report-sub">
							WILAYAH: <?= htmlspecialchars($this->session->userdata('nama_puskesmas') ?: 'Seluruh Wilayah') ?> ·
							PERIODE: <?php
												$bulan_arr = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'];
												echo htmlspecialchars($bulan_arr[(int)$sel_m - 1] . ' ' . $sel_y);
												?>
						</div>
					</div>
					...
					<div class="table-responsive-area">
						...
						<div class="table-sub">
							Daftar data pengukuran balita periode
							<?php
							$bulan_arr_view = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'];
							echo htmlspecialchars($bulan_arr_view[(int)$sel_m - 1] . ' ' . $sel_y);
							?>
						</div>
